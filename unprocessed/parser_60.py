...
# This version of the parser is built specifically for f60.txt and f61.txt in the unprocessed folder.
...
header = to_vocab(tokens[:325])

# get inner plain content as vocabulary
inner = to_vocab(tokens[390:491])
